      ...
      <aside className="w-56 shrink-0 bg-white border-r border-gray-100 sticky top-14 h-[calc(100vh-56px)] overflow-y-auto scrollbar-thin">
        <div className="py-4 px-2">
          <div className="px-3 mb-3">
            <span className="text-[11px] font-medium text-gray-400 uppercase tracking-wider">分类导航</span>
          </div>
          ...
          <div className="flex items-center justify-between mb-3">
            <nav className="text-xs text-gray-500 flex items-center gap-1">
              ...
              {searchQ && (
                <>
                  <span className="text-gray-300">/</span>
                  <span className="text-blue-600">搜索: {searchQ}</span>
            ...
            <div className="text-xs text-gray-400">
              ...
              <span className="ml-2">{total.toLocaleString()} 个网站</span>
            </div>
          </div>
            ...
            <form onSubmit={handleSearch} className="flex gap-2 flex-1 max-w-sm">
              <div className="relative flex-1">
                <input
                  ...
                  placeholder={`搜索${selectedCatName}...`}
        ...
        <div className="px-6 py-4">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-500 text-sm">该分类暂无网站</p>
              <p className="text-gray-400 text-xs mt-1">试试切换其他分类或区域</p>
            </div>
          ) : (
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mb-1">
                          <Link href={`/sites/${site.slug}`} className="font-semibold text-gray-900 hover:text-blue-600 truncate text-[15px] transition-colors">
                            {site.name}
                          </Link>
                          <StarRating rating={star} />
                          <span className="text-[11px] text-gray-400 bg-gray-50 px-1.5 py-0.5 rounded">
                            {formatNumber(views)} 访问
                          </span>
                        </div>
                        {/* 第二行：简介 */}
