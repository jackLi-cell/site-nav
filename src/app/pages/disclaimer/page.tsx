    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            用户通过投稿功能提交的网站信息经过人工审核，但本站无法保证投稿信息在审核通过后始终准确，也无法保证被收录网站在任何时间点都安全可靠。如发现收录网站存在问题，请通过 <a href="/pages/contact" className="text-blue-600 hover:text-blue-800 underline">联系页面</a> 向我们反馈，我们将及时处理。
          </p>
        </section>
